...
router.get("/get-student-score/:studentId", verifyToken, async (req, res) => {
  try {
    ...
    //   part1Score = Number(part1Score.toFixed(1));

    //   // Lấy điểm phần 2 (council hoặc poster)
    //   const part2Score = score.councilScore != null ? score.councilScore : score.posterScore;

    //   // Tính điểm tổng theo tỉ lệ 60% phần 1 + 40% phần 2
    //   if (part2Score != null) {
    //     totalScore = (part1Score * 0.6) + (part2Score * 0.4);
...
//       part1Score = Math.floor(part1Score * 10) / 10;
